...
* PIB y ocupados de cada sector en cada región (% del total de cada sector),
* según año.
* CCNN/ENE
...
foreach var of varlist pib ocupados {
	bysort año rama1_rc : egen sum_`var' = total(`var')
...
* Guardado:
save "$project/data/chart 02-01-05.dta", replace
beep
